                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="space-y-4">
                        ...
                        >
                            ...
                            >
                                <SiOpenproject size={28} />
                            </motion.div>
                            <span>Ashwin Haragi</span>
                        </motion.div>
                    ...
                    >
                        ...
                        >
                            <Heart size={16} fill="currentcolor" className="" />
                        </motion.div>
                    ...
                    <motion.div variants={itemVariants} className="space-y-2">
                        ...
                        >
                        &copy; {new Date().getFullYear()} Ashwin Haragi. All rights reserved.
                        </p>
                        <p className={`text-xs ${
                            isDarkMode
                                ? "text-gray-600"
                    ...
                    <motion.div variants={itemVariants}>
                        <motion.button
                            ...
                            } backdrop-blur-sm border transform-gpu will-change-transform cursor-pointer ${
                                isDarkMode
                                ? "border-gray-700"
                                : "border-gray-300"
                            }`}
